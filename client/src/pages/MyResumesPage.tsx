      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10 border-b border-border/50 pb-6">
          <div>
            ...
            <h1 className="font-display text-4xl font-bold text-foreground">My Resumes</h1>
            <p className="text-muted-foreground mt-2">
              Manage and download your generated CVs
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-32">
            ...
            <p className="text-muted-foreground font-medium text-lg">Loading your resumes...</p>
          </div>
        ) : error ? (
           <div className="bg-destructive/10 border border-destructive/20 text-destructive p-6 rounded-xl text-center max-w-md mx-auto mt-20">
            <p className="font-bold text-lg">Failed to load resumes</p>
          ...
          >
            ...
            <h2 className="font-display font-bold text-2xl mb-2">No resumes yet</h2>
            <p className="text-muted-foreground mb-8">
              You haven't generated any CVs yet. Head over to the gallery to pick a template and create your first one!
            </p>
            <Link 
              href="/"
